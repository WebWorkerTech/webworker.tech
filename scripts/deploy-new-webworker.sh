...
REMOTE_ROOT="${REMOTE_ROOT:-/srv/webworker-tech}"
REMOTE_APP_DIR="${REMOTE_APP_DIR:-/srv/webworker-tech/app}"
REMOTE_CONTENT_DIR="${REMOTE_CONTENT_DIR:-/srv/webworker-tech/content/episodes}"
ENV_FILE="${ENV_FILE:-/srv/webworker-tech/.env.production}"
